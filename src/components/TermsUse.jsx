  ...
  return (
    <div className='container'>
        ...
        <div>
          ...
          <p className='termsparagraph'>We may revise and update these Terms of Use from time to time in our sole discretion as per applicable law. All future changes are effective and binding when they are posted unless the applicable law provides otherwise.</p>
          <p className='termsparagraph'>If you use the website following the posting of revised Terms of Use you accept and agree to the changes. Unless the applicable law provides otherwise, it is your responsibility to check this page from time to time so you are aware of any changes, as they are binding on you if you choose to continue to access or use the website.</p>
        </div>
        <div>
          <h5 className='termsacceptance'>Accessing the Website and Account Security</h5>
        ...
        <div>
          <h5 className='termsacceptance'>Intellectual Property Rights</h5>
        ...
        <div>
          <h5 className='termsacceptance'>User Contributions</h5>
          ...
          <p className='termsparagraph'>All User Contributions must comply with the content standards as set out herein above in Prohibited Uses.</p>
        ...
        <div>
          <h5 className='termsacceptance'>No Reliance on Information Posted</h5>
          ...
          <p className='termsparagraph'>This website may include content provided by third parties, including materials provided by other users, bloggers and third-party licensors, syndicators, aggregators and/or reporting services. All statements and/or opinions expressed in these materials, and all articles and responses to questions and other content, other than the content provided by the Organisation, are solely the opinions and the responsibility of the person or entity providing those materials. We are not responsible, or liable to you or any third party, for the content or accuracy of any materials provided by any third parties.</p>
        </div>
        <div>
          <h5 className='termsacceptance'>Advertising Material</h5>
          <p className='termsparagraph'>Part of the website may contain advertising/other material submitted to us by third parties. Responsibility for ensuring that material submitted for inclusion on the website complies with applicable international and national law is exclusively on the advertisers and we will not be responsible for any claim, error, omission or inaccuracy in advertising material. We reserve the right to omit, suspend or change the position of any advertising material submitted for insertion.</p>
          <p className='termsparagraph'>Information About You and Your Visits to the Website</p>
          <p className='termsparagraph'>All information we collect on this website is subject to our <Link to='/privacy' className='text-decoration-none  footerfont'>Privacy Policy.</Link>By using the website, you consent to all actions taken by us with respect to your information in compliance with the Privacy Policy. We may send information and offers of products and services to you from time to time. For further details, relating to our policy relating to such offer please refer to our <Link to='/privacy' className='text-decoration-none  footerfont'>Privacy Policy.</Link></p>
        </div>
        <div>
          <h5 className='termsacceptance'>Non transferability</h5>
          <p className='termsparagraph'>You agree that your account on the website is non-transferable and any rights to your ID or contents with your said account automatically terminate upon your death. Upon receipt of a copy of a death certificate, your account may be terminated and all contents therein permanently deleted.</p>
        </div>
        <div>
          <h5 className='termsacceptance'>Linking to the Website and Social Media Features</h5>
        ...
        <div>
          <h5 className='termsacceptance'>Cookies</h5>
          <p className='termsparagraph'>This Organisation’s website uses cookies to enable us to retrieve user details for each visit. Cookies are used in some areas of our website to enable the functionality of this area and ease of use for those people visiting. Some of our affiliate partners may also use cookies. Please refer to our <Link to='/cookie' className='text-decoration-none footerfont'>Cookie Policy</Link> for further details.</p>
        </div>
        <div>
          <h5 className='termsacceptance'>Links from the Website</h5>
          <p className='termsparagraph'>If the website contains links to other sites and resources provided by third parties, these links are provided for your convenience only. This includes links contained in advertisements, including banner advertisements and sponsored links. Please be aware that we are not responsible for the privacy practices, or content, of these websites. We encourage our users to be aware when they leave our website and to read the privacy statements of these websites. You should evaluate the security and trustworthiness of any other website connected to this website or accessed through this website yourself, before disclosing any personal information to them. We have no control over the contents of those sites or resources, and accept no responsibility for them or for any loss or damage that may arise from your use of them. If you decide to access any of the third party websites linked to this website, you do so entirely at your own risk and subject to the terms and conditions of use for such websites.</p>
        </div>
        <div>
          <h5 className='termsacceptance'>Disclaimer of Warranties and Liability</h5>
          <p className='termsparagraph'>You acknowledge and understand that we cannot and do not guarantee that files available for downloading from the internet or the website will be free of viruses or other destructive code. You are responsible for implementing sufficient procedures and checks to satisfy your particular requirements for anti-virus protection and accuracy of data input and output, and for maintaining a means external to our site for any reconstruction of any lost data.</p>
          <p className='termsparagraph'>We will not be liable for any loss or damage caused by a distributed denial-of-service attack, viruses or other technologically harmful material that may infect your computer equipment, computer programs, data or other proprietary material due to your use of the website or any services or items obtained through the website or to your downloading of any material posted on it, or on any website linked to it.</p>
          <p className='termsparagraph'>Your use of the website is at your own risk, and its content and any services or items obtained through the website are provided on an "as is" and "as available" basis.</p>
          <p className='termsparagraph'>All the contents of the website are only for general information or use. They do not constitute advice and should not be relied upon in making (or refraining from making) any decision and you should consult an appropriate professional for specific advice tailored to your situation. Any specific advice or replies to queries in any part of the website is/are the personal opinion of such persons and are not subscribed to by the website or us. The information from or through the website is provided on "AS IS" basis, and all warranties, expressed or implied of any kind, regarding any matter pertaining to any goods, service or channel, including without limitation, the implied warranties of merchantability, fitness for a particular purpose, and non-infringement are disclaimed and excluded.</p>
          <p className='termsparagraph'>The Organisation hereby disclaims any warranty, whether express or implied, statutory or otherwise, including but not limited to any warranty of merchantability, non-infringement and fitness for particular purpose, completeness, security, reliability, quality, accuracy or uninterrupted or error-free availability of the website, its content or any services or items obtained through the website, that defects will be corrected, that the Organisation’s website or the server that makes it available are free of viruses or other harmful components or that the website or any services or items obtained through the website will otherwise meet your needs or expectations.</p>
          <p className='termsparagraph'>The foregoing does not affect any warranties that cannot be excluded or limited under applicable law.</p>
        </div>
        <div>
          <h5 className='termsacceptance'>Limitation on Liability</h5>
          <p className='termsparagraph'>In no event will the Organisation, or its employees, agents, officers or directors be liable for damages of any kind, under any legal theory, arising out of or in connection with your use, or inability to use, the website, any websites linked to it, any content on the website or such other websites or any services or items obtained through the website or such other websites, including any direct, indirect, special, incidental, consequential or punitive damages, including but not limited to, personal injury, pain and suffering, emotional distress, loss of revenue, loss of profits, loss of business or anticipated savings, loss of use, loss of goodwill, loss of data, and whether caused by tort (including negligence), breach of contract or otherwise, even if foreseeable.</p>
          <p className='termsparagraph'>The foregoing does not affect any liability that cannot be excluded or limited under applicable law.</p>
        </div>
        <div>
          <h5 className='termsacceptance'>Indemnification</h5>
        ...
        <div>
          <h5 className='termsacceptance'>Governing Law and Jurisdiction</h5>
        ...
        <div>
          <h5 className='termsacceptance'>Force Majeure</h5>
          <p className='termsparagraph'>We shall have no liability to you for any interruption or delay in access to the website irrespective of the cause.</p>
        </div>
        <div>
          <h5 className='termsacceptance'>Waiver and Severability</h5>
          <p className='termsparagraph'>No waiver of by the Organisation of any term or condition set forth in these Terms of Use shall be deemed a further or continuing waiver of such term or condition or a waiver of any other term or condition, and any failure of the Organisation to assert a right or provision under these Terms of Use shall not constitute a waiver of such right or provision.</p>
          <p className='termsparagraph'>If any provision of these Terms of Use is held by a court or other tribunal of competent jurisdiction to be invalid, illegal or unenforceable for any reason, such provision shall be eliminated or limited to the minimum extent such that the remaining provisions of the Terms of Use will continue in full force and effect.</p>
        </div>
        <div>
          <h5 className='termsacceptance'>Entire Agreement</h5>
        ...
        <div>
          <h5 className='termsacceptance'>Your Comments and Concerns</h5>
          <p className='termsparagraph'>This website is operated by Sahaayata Society, India.</p>
          <p className='termsparagraph'>All feedback, comments, requests for technical support and other communications relating to the website should be directed to: <a href='mailto:webmaster@sahaayata.org' className='text-decoration-none'>webmaster@sahaayata.org.</a></p>
          <p className='termsparagraph'>Thank you for visiting the website.</p>
        </div>
        <p className='termslast'>Last updated on 31 May 2021</p>
    </div>
  );
}
