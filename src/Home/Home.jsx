        ...
        <div className="container">
          <div className="row">
            <div className="col-4 py-5 px-3">
              <div>
                <iframe width="100%" height="200px" src="https://www.youtube.com/embed/PhjJEr9Kbac?si=Pex7kQyIGkMYgbBL" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
              </div>
              ...
              <div className="entrySub">
                <h4>
                  Sahaayata 2 days Anubhava Workshop
                </h4>
                <p>For Better Health, Wealth, Relationships, Success and Spiritual Growth</p>
                <h5>Become a Divine Healer in 2 days </h5>

                <p className='entryData py-5'>This workshop is not just a lecture, but a journey and an
                  experiential process in consciousness which leads us to a much evolved and joyous living.
                  All of us sail in the boat of life. We want to make our life very healthy, prosperous, loving, enjoyable, beautiful and happy.
                  All the time we try not to hurt others or not get hurt. We want to maintain good relationships. No person wants problems and sufferings.
                  But none can be free from suffering and problems. But we must know how to overcome problems and suffering. We should first become aware of
                  our problems and analyse the causes,
                  search for solutions and then apply them in our life and be free from them or at least reduce their impact of them in our lives.</p>
              </div>
          ...
          <div className="col-4 py-5 px-3">
            <div className="visionHead">
              <h2>
              Sahaayata - The Vision
              </h2>
            </div>
            <div className="visionBody pt-5">
              <img src={banner3} alt="" />
              <h4>Helping people to help others</h4>
                <p>Set up with this vision to serve and guide
                  people from all walks of life who can find practical
                  solutions to fulfill everyday needs and challenges. To fulf
                  ill this need by serving as a conduit to bridge their scared intent,
                  channeling their resources and
                  enabling people to be beneficiaries in the form of physical Grace manifesting in their life. </p>
            </div>
          </div>
          ...
          <div className="col-4 py-5 px-3">
            ...
            <div className="designBody pt-3">
              ...
              <p>Dedicated to serve as a one stop solution for a plethora of issues ranging from academics, marriage, counseling, sports, coping with health issues, food related issues (hunger/diet/malnutrition), to more subtler issues li
                ke relationships, upbringing, personal success, creativity, professional counseling and family / 
                ancestral guidance / handling failures / breakups / rejections / work relationship related stress / organizational issues …</p>
            </div>
          </div>
            ...
            <div className="designBody pt-3">
              ...
              <div className="">
                <button  className='btn py-1 mb-5 px-3 shadow rounded-1' style={{  border: '.1px solid black' }}>
                  <a href="" className='text-capitalize fw-normal text-black fs-6' >Personal Counselling and Guidance</a>
                </button>
              </div>
          ...
          <div className="col-4 pt-2 pb-5 px-3">
            ...
            <div className="designBody pt-3">
              ...
              <h5>For Better Health, Wealth, Relationships, Success and Spiritual Growth
              For Better Health, Wealth, Relationships, Success and Spiritual Growth</h5>
              <p>This workshop is not just a lecture, but a journey and an experiential process in consciousness which leads us to a much evolved and joyous living. All of us sail in the boat of life. We want to make our life very healthy, prosperous, loving, enjoyable, beautiful and happy. All the time we try not to hurt others or not get hurt. We want to maintain good relationships. No person wants problems and sufferings. But none can be free from suffering and problems. But we must know how to overcome problems and suffering. We should first become aware of our problems and analyse the causes, search for solutions and then apply them in our life and be free from them or at least reduce their impact of them in our lives.</p>
        ...
        <div className="container p-5">
          <div className="links">
            <ol className='' style={{lineHeight:'2rem'}}>
              <li>
                <a href="">
                Sahaayata - For Parenting
                </a>
              </li>
              <li>
                <a href="">
                Sahaayata Projects for the Needy
                </a>
              </li>
              <li>
                <a href="">
              ...
              <li>
                <a href="">
                Sahaayata Vinayaka Archana Puja
                </a>
              </li>
            </ol>
          </div>
